...
async function writesongs(link){
    ...
    for(i of songs){
        let l=(i.split("/songs/hindisongs/"))[1]
    ...
    Array.from(document.querySelector(".songslist").getElementsByTagName("div")).forEach(e=>{
        e.addEventListener("click",()=>{
            ...
            let src="songs/hindisongs/"+song+".mp3"
    ...
    previous.addEventListener("click",()=>{
        ...
        let l=(src.split("/songs/hindisongs/"))[1]
        let a=(l.replaceAll("%20"," "))
        let name=a.split(".")[0]
...
let link="https://saksham10884.github.io/songs/hindisongs.html"
writesongs(link)
